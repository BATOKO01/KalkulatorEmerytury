          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div class="relative">
                <input 
                  ...
                  class="block w-full pl-3 pr-12 py-2.5 rounded-lg border-gray-300 bg-gray-50 border focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                  placeholder="np. 5000"
                >
            ...
            <div>
              ...
              <div class="relative">
                ...
                >
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                  <span class="text-gray-500 sm:text-sm">lat</span>
                </div>
              </div>
            </div>
...
// RESULTS
// ====================================================================== -->
      <div class="bg-indigo-600 rounded-xl shadow-lg p-6 md:p-8 text-white h-fit sticky top-8">
...
const isYearsInvalid = computed(() => nIn.value < 1 || nOut.value < 1);
// #endregion
</script>